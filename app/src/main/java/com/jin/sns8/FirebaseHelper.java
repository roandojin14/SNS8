...
import com.jin.sns8.listener.OnPostListener;
...
public class FirebaseHelper {
    ...
    public void storageDelete(final com.jin.sns8.PostInfo postInfo){
    ...
    private void storeDelete(final String id, final com.jin.sns8.PostInfo postInfo) {
